...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-4">
        ...
        <select id="category" name="category" class="form-select @error('category') is-invalid @enderror">
            <option value="Hardware" {{ old('category', 'Hardware') == 'Hardware' ? 'selected' : '' }}>Hardware</option>
            <option value="Software" {{ old('category') == 'Software' ? 'selected' : '' }}>Software</option>
            <option value="Network & Internet" {{ old('category') == 'Network & Internet' ? 'selected' : '' }}>Network & Internet</option>
            <option value="Billing & Invoices" {{ old('category') == 'Billing & Invoices' ? 'selected' : '' }}>Billing & Invoices</option>
            <option value="Access & Permissions" {{ old('category') == 'Access & Permissions' ? 'selected' : '' }}>Access & Permissions</option>
